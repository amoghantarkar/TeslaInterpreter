...
public interface FileService {
    ...
    /**
     * Takes an {@code inputPath} to read the input from, interpret/parse/process the
     * input file and write it to four different output files at output directory
     * {@code outputDirectoryPath} based on the partition value
     *
