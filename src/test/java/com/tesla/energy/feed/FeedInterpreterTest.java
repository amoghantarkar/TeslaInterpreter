...
public class FeedInterpreterTest {
  ...
  @Test
  public void interpretLine_checkResultWhenValidLine_returnsTrue() {
  ...
  @Test
  public void interpretLine_checkResultWhenInValidLine_returnsFalse() {

    feedLine = "0000000000060,3,4fc18980-0f65-4033-b5b5-4a64effba2f5,#nine,#one,#ten,#two,#seven,#three,#eight,#six,#four";
    Optional<FeedResult> result = FeedInterpreter.interpretLine(feedLine);
